/* W zadaniu nalezy napisac szablon klasy Array ze specjalizacja dla wskaznikow.
   Specjalizacja wp�ywa na kilka aspektow dzialna tego szablonu. 
   W szczegolscnosci na to co robi   destruktor szablonu Array 
   (czy kasuje obiekty, czy nie). Zmieniaja sie takze operator[] i 
   operator <<.
   Klasa X jest trywialnie prosta: przechowuje napis, 
   dostarcza metody dostepowej i podczas destrukcji wypisuje ten napis.
